...
- Simulació de pèrdua i restauració de dades per verificar el funcionament 🔄

## 🐧 Part 2: Còpies de seguretat en servidor Linux
Es crearà una guia tècnica utilitzant **Duplicity** i **cron** per automatitzar còpies completes i incrementals del directori `/home`, garantint:
- Ús de disc extern simulat 📁  
- Còpies encriptades amb passphrase 🔐  
- Desmuntatge automàtic del dispositiu per seguretat 🛡️  
- Restauració i validació de dades ✅
